...
categories: academics matplotlib python
---
...
![Displaying images in a 5x5 grid]({{ site.url }}/assets/post-images/2017-03-19-a.png "Displaying images in a 5x5 grid")

For easy displaying of small patches or windows, there’s also a built-in show_patches().

![As many little patches as you like…]({{ site.url }}/assets/post-images/2017-03-19-b.png "As many little patches as you like")
...
![Plot a graph with multiple lines and a simple legend]({{ site.url }}/assets/post-images/2017-03-19-c.png "Plot a graph with multiple lines and a simple legend")
